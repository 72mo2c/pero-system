-- =============================================================================
-- TENANT DATABASE STRUCTURE - SIMPLIFIED VERSION
-- =============================================================================
-- Warehouse SaaS System - Tenant Database Template (Simplified & Fixed)
-- Created: 2025-10-16
-- 
-- هذا الملف مصمم لتجنب مشاكل الصلاحيات في XAMPP
-- 
-- INSTRUCTIONS / التعليمات:
-- 1. أنشئ قاعدة بيانات جديدة للعميل في phpMyAdmin
-- 2. اختر قاعدة البيانات الجديدة من القائمة اليسرى
-- 3. استورد هذا الملف
-- 
-- مثال لاسم قاعدة البيانات: warehouse_tenant_company1
-- 
-- =============================================================================
...
-- =============================================================================
-- ADD FOREIGN KEY CONSTRAINTS (تم تجميعها في النهاية لتجنب مشاكل الترتيب)
-- =============================================================================

-- Warehouses foreign keys
ALTER TABLE 'warehouses' 
ADD CONSTRAINT 'fk_warehouse_manager' FOREIGN KEY ('manager_id') REFERENCES 'users' ('id') ON DELETE SET NULL,
ADD CONSTRAINT 'fk_warehouse_creator' FOREIGN KEY ('created_by') REFERENCES 'users' ('id') ON DELETE SET NULL;

-- Product categories foreign keys
ALTER TABLE 'product_categories' 
ADD CONSTRAINT 'fk_category_parent' FOREIGN KEY ('parent_id') REFERENCES 'product_categories' ('id') ON DELETE CASCADE,
ADD CONSTRAINT 'fk_category_creator' FOREIGN KEY ('created_by') REFERENCES 'users' ('id') ON DELETE SET NULL;
...
ADD CONSTRAINT 'fk_supplier_creator' FOREIGN KEY ('created_by') REFERENCES 'users' ('id') ON DELETE SET NULL;

-- Customers foreign keys
ALTER TABLE 'customers' 
ADD CONSTRAINT 'fk_customer_creator' FOREIGN KEY ('created_by') REFERENCES 'users' ('id') ON DELETE SET NULL;
...
ADD CONSTRAINT 'fk_po_warehouse' FOREIGN KEY ('warehouse_id') REFERENCES 'warehouses' ('id') ON DELETE RESTRICT,
ADD CONSTRAINT 'fk_po_creator' FOREIGN KEY ('created_by') REFERENCES 'users' ('id') ON DELETE SET NULL,
...
ADD CONSTRAINT 'fk_poi_product' FOREIGN KEY ('product_id') REFERENCES 'products' ('id') ON DELETE RESTRICT;

-- Sales orders foreign keys
ALTER TABLE 'sales_orders' 
ADD CONSTRAINT 'fk_so_customer' FOREIGN KEY ('customer_id') REFERENCES 'customers' ('id') ON DELETE RESTRICT,
ADD CONSTRAINT 'fk_so_warehouse' FOREIGN KEY ('warehouse_id') REFERENCES 'warehouses' ('id') ON DELETE RESTRICT,
ADD CONSTRAINT 'fk_so_creator' FOREIGN KEY ('created_by') REFERENCES 'users' ('id') ON DELETE SET NULL,
ADD CONSTRAINT 'fk_so_approver' FOREIGN KEY ('approved_by') REFERENCES 'users' ('id') ON DELETE SET NULL;

-- Sales order items foreign keys
ALTER TABLE 'sales_order_items' 
ADD CONSTRAINT 'fk_soi_so' FOREIGN KEY ('sales_order_id') REFERENCES 'sales_orders' ('id') ON DELETE CASCADE,
ADD CONSTRAINT 'fk_soi_product' FOREIGN KEY ('product_id') REFERENCES 'products' ('id') ON DELETE RESTRICT;

-- Stock movements foreign keys
ALTER TABLE 'stock_movements' 
ADD CONSTRAINT 'fk_movement_product' FOREIGN KEY ('product_id') REFERENCES 'products' ('id') ON DELETE RESTRICT,
ADD CONSTRAINT 'fk_movement_warehouse' FOREIGN KEY ('warehouse_id') REFERENCES 'warehouses' ('id') ON DELETE RESTRICT,
ADD CONSTRAINT 'fk_movement_creator' FOREIGN KEY ('created_by') REFERENCES 'users' ('id') ON DELETE SET NULL;

-- Treasury accounts foreign keys
ALTER TABLE 'treasury_accounts' 
ADD CONSTRAINT 'fk_treasury_creator' FOREIGN KEY ('created_by') REFERENCES 'users' ('id') ON DELETE SET NULL;

-- Treasury transactions foreign keys
ALTER TABLE 'treasury_transactions' 
ADD CONSTRAINT 'fk_transaction_treasury' FOREIGN KEY ('treasury_account_id') REFERENCES 'treasury_accounts' ('id') ON DELETE RESTRICT,
ADD CONSTRAINT 'fk_transaction_creator' FOREIGN KEY ('created_by') REFERENCES 'users' ('id') ON DELETE SET NULL,
ADD CONSTRAINT 'fk_transaction_approver' FOREIGN KEY ('approved_by') REFERENCES 'users' ('id') ON DELETE SET NULL;
